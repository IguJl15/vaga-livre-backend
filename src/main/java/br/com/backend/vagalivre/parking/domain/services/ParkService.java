...
public class ParkService {
    ...
    public List<Park> findParkByTerm(String term) {
        Assert.hasText(term, "Search term cannot be null or empty.");

        return parkRepository.findByNameContainingIgnoreCaseAndDescriptionIgnoreCase(term, term);
    }
